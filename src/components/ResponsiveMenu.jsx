...
const ResponsiveMenu = ({ open, setOpen }) => {
    return (
        <div className={`${open ? "left-0" : "-left-[100%]"} fixed bottom-0 top-0 z-20 flex h-screen w-[75%] flex-col justify-between bg-orange-600 px-4 pb-6 pt-6 text-black md:hidden rounded-r-xl shadow-md transition-all`}>
            <div className="bg-yellow-800 rounded-md p-4 flex flex-col items-center">
                ...
                <h1 className="text-white font-bold text-center text-2xl mt-4">Eze-Oge Samuella</h1>
                <p className="text-white bg-yellow-600 rounded-md py-2 text-center mx-4 mt-2 shadow-sm">
                    Software Engineer
                </p>
                <hr className="border-yellow-500 mx-4 mt-6 w-full" />

                {/* Navigation Links */}
                <nav className="mt-6">
                    <ul className="flex flex-col gap-4 items-center text-white text-lg font-medium">
                        <NavLink
                            to="/"
                            className={({ isActive }) =>
                ...
                {/* Contact Information */}
                <div className="mt-8 px-4 space-y-6 w-full">
                    <div className="flex gap-4 items-center">
                        <div className="bg-gray-700 p-3 rounded-full shadow-md">
                            <FaRegEnvelope className="text-yellow-400 text-2xl" />
                        </div>
                        <div className="text-white">
                            <h1 className="font-semibold">EMAIL</h1>
                            <p className="text-gray-300">ezeogesamuella@gmail.com</p>
                        </div>
                    </div>
                    <div className="flex gap-4 items-center">
                        <div className="bg-gray-700 p-3 rounded-full shadow-md">
                            <MdOutlinePhoneIphone className="text-yellow-400 text-2xl" />
                        </div>
                        <div className="text-white">
                            <h1 className="font-semibold">PHONE</h1>
                            <p className="text-gray-300">+234 8144550804</p>
                        </div>
                    </div>
                    <div className="flex gap-4 items-center">
                        <div className="bg-gray-700 p-3 rounded-full shadow-md">
                        ...
                        <div className="text-white">
                            <h1 className="font-semibold">BIRTHDAY</h1>
                            <p className="text-gray-300">16 June, 2006</p>
                        </div>
                    </div>
                    <div className="flex gap-4 items-center">
                        <div className="bg-gray-700 p-3 rounded-full shadow-md">
